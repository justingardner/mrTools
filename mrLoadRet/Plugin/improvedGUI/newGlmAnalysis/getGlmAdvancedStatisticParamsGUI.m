...
while keepAsking
  ...
  paramsInfo = {...
    ...
    {'alphaConfidenceIntervals', params.alphaConfidenceIntervals,'contingent=bootstrapIntervals', 'minmax=[0 1]', 'Confidence Intervals will be computed as fractiles [alpha/2 1-alpha/2] of the bootstrap-estimated null distribution'},...
