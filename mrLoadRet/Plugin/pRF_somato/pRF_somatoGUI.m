...
paramsInfo{end+1} = {'rfType',...
    {'gaussian-1D','gaussian-1D-transpose', 'nine-param-hdr','sixteen-hdr','gaussian','gaussian-hdr','gaussian-hdr-double','gaussian-surround','six-param','nine-param', 'gaussian-1D-orthotips', 'five-hdr', 'four-hdr'},...
