...
%       ~isequal(size(scanParams{iScan}.stimToEVmatrix,2),params.numberEVs)
  ...
  paramsInfo = [paramsInfo {...
    ...
    {'showDesign', 0, 'type=pushbutton','passCallbackOutput=0','buttonString=Show Design','Shows the experimental design (before convolution with an HRF model) and the design matrix.',...
