function [view, userCancel] = newROI(view,name,select,color,xform,voxelSize,coords,xformCode,vol2tal,vol2mag,notes)

% function view = newROI(view,[name],[select],[color],[xform],[voxelSize],[coords],[xformCode],[vol2tal],[vol2mag],[notes])
%
...
if ieNotDefined('notes')
  notes = '';
end


if ieNotDefined('color') || ieNotDefined('name')
