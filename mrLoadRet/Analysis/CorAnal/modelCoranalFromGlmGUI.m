...
while askForParams
  paramsInfo = {...
      {'originalGroup',groupNames,'Name of the Group from which the GLM anlaysis is taken'},...
      ...
      {'nScans',params.nScans,'bla'},...
      {'reverseScans', params.reverseScans, 'bla'},...
      {'ncycles', params.ncycles, 'bla'},...
      {'cycleLengthTR', params.cycleLengthTR, 'bla'},...
      {'stimDurationS', params.stimDurationS, 'bla'},...
      {'dummyStimsTR', params.dummyStimsTR,  'bla'},...
      {'delayTR', params.delayTR, 'bla'},...
      {'TRCorrection', TRCorrectionMenu, 'type=popupmenu', 'bla'},...
      {'noiseMode', noiseModeMenu, 'type=popupmenu', 'bla'},...
      {'detrend', detrendMenu, 'type=popupmenu', 'bla'},...
