...
prefParams = {{'site',site,'Where you are using this code'},...
    ...
    {'mlrAnatDBGitRepo',mlrAnatDBGitRepo,'If you are using the mlrAnatDB plugin, then this is the reference to the git repo you are using. For example: https://myhost.edu/myAnat.git'},...
...
if ~isempty(prefParams)
  ...
  mrSetPref('mlrAnatDBGitRepo',prefParams.mlrAnatDBGitRepo);
