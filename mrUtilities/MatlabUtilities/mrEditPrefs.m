...
prefParams = {{'site',site,'Where you are using this code'},...
    ...
    {'mlrAnatDBCentralRepo',mlrAnatDBCentralRepo,'If you are using the mlrAnatDB plugin, then this is the reference to the central repo you are using. For example: https://myhost.edu/myAnatCentralRepo'},...
