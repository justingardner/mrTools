...
paramsInfo = {...
    ...
    {'qformSet',{'Set qform','Identity','sform','vol2mag','vol2tal'},'callback',@setXform,'callbackArg','qform','passParams=1','Set the qform'}...
    ...
    {'sformSet',{'Set sform','Identity','qform','vol2mag','vol2tal'},'callback',@setXform,'callbackArg','sform','passParams=1','Set the sform'}...
    ...
    {'vol2magSet',{'Set vol2mag','Identity','qform','sform','vol2tal'},'callback',@setXform,'callbackArg','vol2mag','passParams=1','Set the vol2mag'}...
    ...
    {'vol2talSet',{'Set vol2tal','Identity','qform','sform','vol2mag'},'callback',@setXform,'callbackArg','vol2tal','passParams=1','Set the vol2tal'}...
	     };
