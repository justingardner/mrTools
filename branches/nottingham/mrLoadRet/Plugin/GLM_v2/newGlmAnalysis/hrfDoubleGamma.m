...
paramsInfo = {...
    ...
    {'displayHRF',0,'type=pushbutton','callback',@dispModelHRF,'passCallbackOutput=0','buttonString=Display HRF','passParams=1','callbackArg',{threshold sampleDuration sampleDelay},'Display the hrf with current parameters'},...
};
